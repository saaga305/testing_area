...
if (isMobile) {
    ...
    // Check if desktop view was previously enabled
    if (localStorage.getItem('desktopView') === 'enabled') {
        body.classList.add('desktop-view');
        desktopViewToggle.textContent = 'View Mobile Site';
    }
    
    desktopViewToggle.addEventListener('click', function() {
        if (body.classList.contains('desktop-view')) {
            body.classList.remove('desktop-view');
            localStorage.setItem('desktopView', 'disabled');
            desktopViewToggle.textContent = 'View Desktop Site';
        } else {
            body.classList.add('desktop-view');
            localStorage.setItem('desktopView', 'enabled');
            desktopViewToggle.textContent = 'View Mobile Site';
        }
    });
}
